    ...
    <div class="canvas gallery"><br>
        ...
        <span class="title-divider"></span>
            ...
            <section id="photostack-3" class="photostack">
                <div>
                    <figure>
                        <a href="./resources/img/a.jpg"  data-lightbox="studio2" class="photostack-img"><img src="./resources/img/a1.jpg" alt="img05"/></a>
                        <figcaption>
                    ...
                    <figure>
                        <a href="./resources/img/b.jpg"  data-lightbox="studio2" class="photostack-img"><img src="./resources/img/b1.jpg" alt="img02"/></a>
                        <figcaption>
                    ...
                    <figure>
                        <a href="./resources/img/c.jpg"  data-lightbox="studio2" class="photostack-img"><img src="./resources/img/c1.jpg" alt="img03"/></a>
                        <figcaption>
                    ...
                    <figure>
                       <a href="./resources/img/d.jpg"  data-lightbox="studio2" class="photostack-img"><img src="img/d1.jpg" alt="img01"/></a>
                        <figcaption>
                    ...
                    <figure>
                        <a href="./resources/img/e.jpg"  data-lightbox="studio2" class="photostack-img"><img src="img/e1.jpg" alt="img04"/></a>
                        <figcaption>
                    ...
                    <figure>
                        <a href="./resources/img/f.jpg"  data-lightbox="studio2" class="photostack-img"><img src="img/f1.jpg" alt="img06"/></a>
                        <figcaption>
                    ...
                    <figure data-dummy>
                        <a href="#" class="photostack-img"><img src="./resources/img/7.jpg" alt="img07"/></a>
                        <figcaption>
                            <h2 class="photostack-title">Lovely Green</h2>
                        </figcaption>
                    </figure>
                    <figure data-dummy>
                        <a href="#" class="photostack-img"><img src="./resources/img/8.jpg" alt="img08"/></a>
                        <figcaption>
                            <h2 class="photostack-title">Wonderful</h2>
                        </figcaption>
                    </figure>
                    <figure data-dummy>
                        <a href="#" class="photostack-img"><img src="./resources/img/9.jpg" alt="img09"/></a>
                        <figcaption>
                            <h2 class="photostack-title">Love Addict</h2>
                        </figcaption>
                    </figure>
                    <figure data-dummy>
                        <a href="#" class="photostack-img"><img src="./resources/img/10.jpg" alt="img10"/></a>
                        <figcaption>
                            <h2 class="photostack-title">Friendship</h2>
                        </figcaption>
                    </figure>
                    <figure data-dummy>
                        <a href="#" class="photostack-img"><img src="./resources/img/11.jpg" alt="img11"/></a>
                        <figcaption>
                            <h2 class="photostack-title">White Nights</h2>
                        </figcaption>
                    </figure>
                    <figure data-dummy>
                        <a href="#" class="photostack-img"><img src="./resources/img/12.jpg" alt="img12"/></a>
                        <figcaption>
                            <h2 class="photostack-title">Serendipity</h2>
                        </figcaption>
                    </figure>
                    <figure data-dummy>
                        <a href="#" class="photostack-img"><img src="./resources/img/13.jpg" alt="img13"/></a>
                        <figcaption>
                            <h2 class="photostack-title">Pure Soul</h2>
                        </figcaption>
                    </figure>
                    <figure data-dummy>
                        <a href="#" class="photostack-img"><img src="./resources/img/14.jpg" alt="img14"/></a>
                        <figcaption>
                            <h2 class="photostack-title">Winds of Peace</h2>
                        </figcaption>
                    </figure>
                    <figure data-dummy>
                        <a href="#" class="photostack-img"><img src="./resources/img/15.jpg" alt="img15"/></a>
                        <figcaption>
                            <h2 class="photostack-title">Shades of blue</h2>
                        </figcaption>
                    </figure>
                    <figure data-dummy>
                        <a href="#" class="photostack-img"><img src="./resources/img/16.jpg" alt="img16"/></a>
                        <figcaption>

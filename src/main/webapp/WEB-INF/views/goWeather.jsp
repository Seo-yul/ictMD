		...
		$("#searchWeather")
				.on(
						...
						function() {
							...
							var urlAddr = "http:////api.openweathermap.org/data/2.5/weather?q="
									+ cityName
							...
							$.ajax({
								...
								success : function(data) {
									...
									console.log("위도 및 경도 : " + data.coord.lon
											+ ", " + data.coord.lat)
									console.log("현재 날씨 : "
											+ data.weather[0].main);
									console
									...
									console.log("지역순간최고온도 : "
											+ (data.main.temp_max - 273.15));
									console.log("지역순간최저온도 : "
							...
							var foreUrl = "http:////api.openweathermap.org/data/2.5/forecast?q="
									+ cityName
									+ "&mode=xml&appid=8d9df8e528baa07108cb74b3776716c3";
							$.ajax({
								url : foreUrl,
								type : "get",
								dataType : "xml",

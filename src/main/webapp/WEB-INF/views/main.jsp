...
<head>
	...
	<script type="text/javascript">
        ...
        markerimg = "./resources/img/marker/Saint_Basil_s_Cathedral.png"
        ...
        markerimg = "./resources/img/marker/Pyramids_of_Giza.png"
...
<body onload="firstFunction()">
    ...
    <!--end-->
		...
		<div id="lmInfo">
			<div id="lmFrame">
				<div id="lmTitle"></div>
				<div id="lmImage">Brand new picture of this landmark</div>
				<br>
				<div id="lmLocation"></div>
				<br>
				<div id="lmSearch">Search about this landmark now!</div>
			</div>
		</div>
	</div>
